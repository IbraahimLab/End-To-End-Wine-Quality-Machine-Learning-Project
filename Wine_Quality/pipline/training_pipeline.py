...
from wine_quality.components.model_pusher import ModelPusher    
...
# HERE STARTS DATA INGESTION METHOD  
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact: 
        """
        This method of data ingestion class is responsible for starting data ingestion component
        """
        try:
...
# HERE STARTS DATA VALIDATION METHOD  
    ...
    def start_data_validation(self, data_ingestion_artifact: DataIngestionArtifact) -> DataValidationArtifact:
        """
        This method of data validation class is responsible for starting data validation component
        """
...
# HERE STARTS DATA TRANSFORMATION METHOD  
    ...
    def start_data_transformation(self, data_ingestion_artifact: DataIngestionArtifact, data_validation_artifact: DataValidationArtifact) -> DataTransformationArtifact:
        """
        This method of data trasformation class is responsible for starting data transformation component
        """
        try:
...
# HERE STARTS MODEL TRAINER METHOD
...
# HERE STARTS MODEL EVALUATION METHOD


    def start_model_evaluation(self, data_ingestion_artifact: DataIngestionArtifact,
                               model_trainer_artifact: ModelTrainerArtifact) -> ModelEvaluationArtifact:
        """
        This method of model evaluation class is responsible for starting model evaluation
        """
        try:
...
# HERE STARTS MODEL PUSHER METHOD
...
# HERE STARTS RUN PIPELINE METHOD THE ONE WHO RUNS THE SYSTEM
