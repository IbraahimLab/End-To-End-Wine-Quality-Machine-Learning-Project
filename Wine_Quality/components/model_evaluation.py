...
from wine_quality.constants import TARGET_COLUMN, CURRENT_YEAR
...
from wine_quality.entity.estimator import TargetValueMapping
...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[WineEstimator]:
        """
        ...
        try:
            ...
            wine_estimator = WineEstimator(bucket_name=bucket_name,
                                               model_path=model_path)

            if wine_estimator.is_model_present(model_path=model_path):
                return wine_estimator
            return None
        except Exception as e:
